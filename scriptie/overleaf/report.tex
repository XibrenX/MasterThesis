...
% As mentioned, the underlaying model for Tielenburg~\cite{TEJ2017} is provided by 
% Jonker and Maauw~\cite{JM2017}.
...
%     \item JM
%     \begin{itemize}
%         \item wel voor aanval
%         \item niet compleet genoeg
%         \item Hier heeft Tieleburg op verder gewerkt
%     \end{itemize}
% \end{itemize}
% }
...
% \outline{
%     \begin{itemize}
%     \item Kan BH iets vinden
%         \begin{itemize}
%             \item Nee, wel inspiratie
%             \item Kunnen we verder niet toepassen
%         \end{itemize}
%     \end{itemize}
% }
...
%         \begin{itemize}
%             \item Geeft inzicht
%             \item Niet voldoende voor aanval detectie
%         \end{itemize}
%     \end{itemize}
% }
...
%% Without going into too much details about the datasets (we will come back to 
%% this in Chapter~\ref{chp:data}), we want to point out the publications describing these datasets.
...
is an issue here. 
% \todo{Hoe veel dan? Iets van aantallen?}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=16cm]{images/case_study_1/cs1_outliers.png}
...
% \paragraph{Extraction of information from PDF}
...
% surprisingly, the results were worse with Latex then with PDF. 
...
% Hashmi et al. provides an overview with possible methods to extract 
% information from the text. They describe the Machine Learning, Rule-based and 
% hybrid approaches \cite{hashmi2020insights}.
% In this research we also going to parse documents, not papers but documents 
% containing roles of the publication process (sometimes called mastheads or front 
% matter).
