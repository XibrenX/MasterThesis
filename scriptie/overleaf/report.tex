...
\begin{description}
    \item[Option 1: Convert to HTML] There are multiple tools available to 
        ...
        libraries (see \nameref{gen_impl:parsing_html}). Unfortunately, the resulting HTML pages are complex to
        interpret
...
\begin{figure}[H]
    \centering
    \includegraphics[width=13cm]{images/case_study_1/implementation/functional_overview.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=13cm]{images/case_study_1/implementation/functional_overview_top_conference.png}
...
% As a 
% recap; our purpose is to prove that added data not available in standard datasets 
% can help identifying egregious people, we are not focusing on creating a foolproof 
% end-to-end solution.
...
% \begin{description}
%     \item[Members] The members from the front matter documents.
%     \item[Articles] The Front Matter and Springer website are joined together 
%     on \dblp{} key. From this proceeded we can get the chapters (articles) involved.
...
% For outlier detection we use a component of Microsoft PowerBI (data visualisation
% application). This component enables us
% to reduce the properties of the editors used in this analysis to one value
% \footnote{\url{https://github.com/microsoft/PowerBI-visuals-outliers-det/blob/master/r_files/utils.r#L168}}\footnote{\url{https://www.rdocumentation.org/packages/stats/versions/3.6.2/topics/prcomp}} using singular value decomposition.

% % We apply an outlier detection on the singular value decomposition 
% % of the scaled properties. 
% % Singular value decomposition is a technique to reduce dimensions.
...
% We notice three outliers cases on the right side. If we break the principal analysis 
